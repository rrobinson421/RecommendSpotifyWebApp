...
##Spotipy Method
def get_recommendations_default(seed_artists, seed_tracks, seed_genres, lim, filter):
    if not seed_artists or seed_artists == ['']: seed_artists = None
    if not seed_tracks or seed_tracks == ['']: seed_tracks = None
    if not seed_genres or seed_genres == ['']: seed_genres = None
    ##results = sp.recommendations(seed_artists=seed_artists, seed_tracks=seed_tracks, seed_genres=seed_genres, limit=lim)
    results = sp.recommendations(seed_artists=[get_artist_id()])
...
##TODO: Check if songs also exist on last.fm
##TODO: Find recommendations using last.fm recommendation API